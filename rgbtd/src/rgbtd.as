...
//		_root.urlmap=new URLmap();
		...
		_root.rgbtd=new rgbtd();
		_root.signals=new BetaSignals(_root.rgbtd);
		_root.comms=new BetaComms(_root.rgbtd);
...
*/
	...
	function setup()
	{
		...
		play=new rgbtdPlay(this);
		lselect=new rgbtdLevels(this);
		menu=new rgbtdMenu(this);
...
//			update_time=Math.floor(update_time*3/4);
			...
			if(update_time>80) { update_time=80; }
			...
			this[state].update_less(); // less important updates
		}
