...
class #(VERSION_BASENAME)Play
{
	...
	function #(VERSION_BASENAME)Play(_up)
	{
		up=_up;
	...
	var vt;
		...
		up.select.manifest_level(up.game_seed);			
		...
		_root.signals.signal("ocw0","start",this);
	...
	function clean()
	{
		_root.signals.signal("ocw0","end",this);
...
//				new_map="\n\t"+
		...
		if(!_root.popup)
		{
			...
			_root.signals.signal("ocw0","update",this);
