...
// overide only basic wetplay settings
		...
		orset_root("wp_xspf","http://swf.wetgenes.com/swf/OneClickWin.xspf");
...
//		_root.urlmap=new URLmap();
		...
		_root.ocw=new OneClickWin();
		_root.signals=new BetaSignals(_root.ocw);
		_root.comms=new BetaComms(_root.ocw);
...
*/
	...
	function setup()
	{
		...
		play=new ocwPlay(this);
		select=new ocwSelect(this);
		menu=new ocwMenu(this);
