...
local rouge_map=require("wet.state.rouge.map")
local rouge_room=require("wet.state.rouge.room")
local rouge_cell=require("wet.state.rouge.cell")
local rouge_item=require("wet.state.rouge.item")
local rouge_char=require("wet.state.rouge.char")
local rouge_attr=require("wet.state.rouge.attr")

local rouge_item_data=require("wet.state.rouge.item_data")
local rouge_char_data=require("wet.state.rouge.char_data")




module("wet.state.rouge.level")
