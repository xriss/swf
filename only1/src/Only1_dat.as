...
//------------------------------------------------------------------------
		...
		d.tard="riddler";
		d.type="tard";
		d.say=delegate(say_demand,d);
		d.sign=delegate(sign_convo,d);
		d.jump=delegate(jump_convo,d);
		
		c=[];
		d.convo=c;
		c.hello=["I am the demanding one.<br>I demand that you do things.",
					"What if I dont wanna?^devious","dont",
					"What do you want?^thoughtful","demand"];
		c.demand=["CONVO_S","...","hello"];
		c.got=["Thank you, here is a power radish that I do not need anymore, you may use it to fetch me more things.^happy","...","hello"];
		c.done=["My needs have been met.^happy","...","hello"];
		c.dont=["Then I shall cry.^sad","...","hello"];
		
		var dem=function(num,nam)
		{
			var de={};
			de.name=nam;
			t.demands[nam]=de;
			t.demands[t.demands.length]=de;
			var dd=t.n(num,"dem_"+nam);
			dd.html=(nam+".");
			dd.img="object_"+nam;
			dd.type="item";
			dd.score=100;
			dd.dem=de;
			de.s="Bring me a shrubery made of "+de.name+".";
		...
		d=dem(0x20,"fish");
		d.html=("Fresh fishy.");
		d.dem.s="Bring me what a kitten would be if it lived in the sea.";
		
		d=dem(0x21,"knife");
		d.html=("A device for stabbing and cutting with.");
		d.dem.s="To stab or not to stab, what is the question?";
		
		d=dem(0x22,"sashimi");
		d.html=("Sashimi!");
		d.dem.s="What once was alive but is now mostly dead and not cooked.";
		
		d=dem(0x23,"milk");
		d.html=("Milk of the cow.");
		d.dem.s="The juice of a large herbivore is required to complete this quest.";

		d=dem(0x24,"bread");
		d.html=("Fresh baked bready goodness.");
		d.dem.s="I require raw toast as quick as you can.";

		d=dem(0x25,"cheese");
		d.html=("CHEESE!");
		d.dem.s="Bring me The Food Of The Gods.";

		d=dem(0x26,"eggs");
		d.html=("Eggs.");
		d.dem.s="Bring me that which came first.";

		d=dem(0x27,"toast");
		d.html=("Toast.");
		d.dem.s="I spy with my little eye something beginning with bread.";
		
		d=dem(0x28,"cheese_on_toast");
		d.html=("Melted cheese on crunchy toast.");
		d.dem.s="What is like pizza if you put ketchup on it?";
		
		d=dem(0x29,"french_toast");
		d.html=("French toast.");
		d.dem.s="Does everything dipped in egg become french?";
	
		d=dem(0x2a,"boiled_eggs");
		d.html=("Boiled eggs.");
		d.dem.s="A quick breakfast still takes three minutes?";

		d=dem(0x2b,"eggy_soldiers");
		d.html=("Eggy soldiers.");
		d.dem.s="When I was a child, I ate as a child. When I was older, I also ate as a child?";
		
		d=dem(0x2c,"omelette");
		d.html=("Omelette.");
		d.dem.s="What happens if you forget to scramble?";
		
		d=dem(0x2e,"cheese_omelette");
		d.html=("Cheese omelette.");
		d.dem.s="Cheese is only the begining, as is ovulation?";
		...
		{
			var i_rand = random(demands.length);
			var spare=demands[i];
			demands[i]=demands[i_rand];
			demands[i_rand]=spare;
		}
