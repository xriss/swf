...
local gg;
	...
	ga=grd.create("GRD_FMT_U8_BGRA",format("cards/wetpokr/%s%02d.png",v,i))
	
	print("doing "..format("cards/wetpokr/%s%02d.png",v,i))
...
--[[ apply grad
	...
	ga:save(format("cards/wetpokr/out/%s%02d.png",v,i))
