...
/**
 * {@code BatchUpdateListener} can be implemented by classes which want to be
 * notified when a batch updates. An instance of the implementing class can then
 ...
 * the observed batch for details on when it distributes update events.
 *
 ...
 */
interface org.as2lib.app.exec.BatchUpdateListener extends BasicInterface {

	/**
	 * Is executed when the observed batch updates.
	 *
	 * @param batch the batch that updated
	 */
