...
/**
 * {@code SimpleTextFileFactory} creates {@link SimpleTextFile} instances.
 *
...
class org.as2lib.io.file.SimpleTextFileFactory extends BasicClass implements TextFileFactory {
	...
	/**
	 * Creates a new {@link SimpleTextFile} instance for the loaded file.
	 *
	 ...
	 * @return the simple text file which represents the loaded file
	 */
	public function createTextFile(content:String, size:Byte, uri:String):TextFile {
		return new SimpleTextFile(content, size, uri);
	}
}