...
/**
 * {@code XmlFileFactory} creates {@link XmlFile} instances.
 *
...
class org.as2lib.io.file.XmlFileFactory extends BasicClass implements TextFileFactory {
	...
	/**
	 * Creates a new {@link XmlFile} instance for the loaded file.
	 *
	 ...
	 * @return the xml file which represents the loaded file
	 */
	public function createTextFile(content:String, size:Byte, uri:String):TextFile {
		return new XmlFile(content, size, uri);
	}
