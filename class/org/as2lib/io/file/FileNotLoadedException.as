...
/**
 * {@code FileNotLoadedException} is thrown when a file is requested that has not
 * been loaded yet.
 *
 ...
 * @version 1.0
 */
class org.as2lib.io.file.FileNotLoadedException extends Exception {

	/**
	 * Constructs a new {@code FileNotLoadedException} instance.
	 *
	 ...
	 */
	public function FileNotLoadedException(message:String, scope, args:Array) {
