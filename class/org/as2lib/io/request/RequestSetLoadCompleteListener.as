 ...
 * @version 1.0
 */
interface org.as2lib.io.request.RequestSetLoadCompleteListener {
	
	/**
	 * Event to be published if the {@code RequestManager} has completed loading.
	 * 
	 * @param {@code RequestManager}
	 */
	public function onRequestSetLoadComplete(requestManager:RequestManager):Void;
}