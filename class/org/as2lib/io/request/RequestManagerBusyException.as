...
import org.as2lib.io.request.RequestException;

/**
 * {@code RequestManagerBusyException} is thrown if RequestManager is busy and 
 * can't handle given request.
 * 
 * @author Akira Ito
 * @version 1.0
 */
class org.as2lib.io.request.RequestManagerBusyException extends RequestException {
	
	/**
	 * Constructs a new {@code RequestManagerBusyException} instance.
	 * 
	...
	public function RequestManagerBusyException(message:String, thrower, args:Array) {
