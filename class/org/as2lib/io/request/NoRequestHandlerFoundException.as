...
/**
 * {@code NoRequestHandlerFoundException} is thrown if there's no appropriate handler found 
 * for given request.
 * 
 * @author Akira Ito
 * @version 1.0
 */
class org.as2lib.io.request.NoRequestHandlerFoundException extends RequestException {
	
	/**
	 * Constructs a new {@code NoRequestHandlerFoundException} instance.
	 * 
	...
	public function NoRequestHandlerFoundException(message:String, thrower, args:Array) {
