...
/**
 * {@code RequestException} is the base exception of any exception in the
 * {@code org.as2lib.io.request} package.
 * 
 * @author Akira Ito
 * @version 1.0
 */
class org.as2lib.io.request.RequestException extends Exception {
	
	/**
	 * Constructs a new {@code RequestException} instance.
	 * 
	 ...
	 */
	public function RequestException(message:String, thrower, args:Array) {
