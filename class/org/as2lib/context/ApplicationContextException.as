...
/**
 * {@code ApplicationContextException} is thrown if an error occurred during application
 * context initialization.
 * 
 * @author Simon Wacker
 */
class org.as2lib.context.ApplicationContextException extends FatalBeanException {
	
	/**
	 * Constructs a new {@code ApplicationContextException} instance.
	 *
	 ...
	 */
	public function ApplicationContextException(message:String, object, args:Array) {
