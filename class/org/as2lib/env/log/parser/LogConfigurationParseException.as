...
/**
 * {@code LogConfigurationParseException} is thrown if parsing a log configuration
 * failed due to a malformed log configuration. This can be a wrong syntax or
 * missing or wrong information.
 * 
 * @author Simon Wacker
 */
class org.as2lib.env.log.parser.LogConfigurationParseException extends FatalException {
	
	/**
	 * Constructs a new {@code LogConfigurationParseException} instance.
	 *
	 ...
	 */
	public function LogConfigurationParseException(message : String, thrower, args : Array) {
