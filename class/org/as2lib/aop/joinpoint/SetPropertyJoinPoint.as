...
class org.as2lib.aop.joinpoint.SetPropertyJoinPoint extends PropertyJoinPoint {
	 ...
	 */
	public function SetPropertyJoinPoint(info:PropertyInfo, thiz, args:Array) {
	 ...
	 * 
	 * <p>If {@code args} is not specified, the original invocation arguments will be
	 * used.
	 * 
	...
	public function proceed(args:Array) {
		return proceedMethod(this.info.getSetter(), args);
	}
