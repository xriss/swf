...
class org.as2lib.aop.advice.AbstractAfterThrowingAdvice extends AbstractAdvice {
	...
	/**
	 * Proceeds the passed-in {@code joinPoint} and returns the result of this
	 * procession after invoking this advice's {@code execute} method passing the given
	 * {@code joinPoint} and the thrown exception.
	 * 
	 * <p>Note that this advice's {@code execute} method is only invoked if the
	 * procession of the {@code joinPoint} resulted in an exception.
	 * 
