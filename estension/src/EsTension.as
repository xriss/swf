...
class EsTension
{
	...
	{
		gfx.clear(_root);
		_root.style.fill=0xff000080;
		gfx.draw_box(_root,0,-2048,-2048,4096,4096);
...
// overide only basic wetplay settings
		...
		_root.estension=new EsTension();
		_root.signals=new BetaSignals(_root.estension);
		_root.comms=new BetaComms(_root.estension);
...
//		lv_wonderful.sendAndLoad('http://swf.wetgenes.com/swf/wonderful.php?id=3489',lv_wonderful,"POST");
	...
	var date=new Date();
		...
		play=new EsPlay(this);
		menu=new EsMenu(this);
