...
class Replay
{
	...
	static var CODE_VERSION		:Number	=	0;
	static var CODE_TIME_64		:Number	=	1;
	static var CODE_TIME_4096	:Number	=	2;
	static var CODE_KEY			:Number	=	3;
...
// or use the prekey system to setup keys to change on update

// then you can just check the keybits in play or record modes
	function update()
	{
		key_on=0;
		key_off=0;
