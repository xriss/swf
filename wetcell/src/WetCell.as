...
// overide only basic wetplay settings
		...
		orset_root("wp_xspf","http://swf.wetgenes.com/swf/WetCell.xspf");
		orset_root("wp_force",1);
...
//		_root.urlmap=new URLmap();
		...
		_root.wetcell=new WetCell();
		_root.signals=new BetaSignals(_root.wetcell);
		_root.comms=new BetaComms(_root.wetcell);
	...
	var idx;
		...
		MainStatic.choose_and_apply_scalar(this,"800x600");
	}
	...
	function setup()
	{
		...
		play=new WetDikePlay(this);
		menu=new WetCellMenu(this);
