...
class RomZom
{
	...
	static function main()
	{
		...
		_root.romzom=new RomZom();
		_root.signals=new BetaSignals(_root.romzom);
		_root.comms=new BetaComms(_root.romzom);
...
// ask for advert details from server
	...
	var date=new Date();
		...
		play=new RomZomPlay(this);
		skip=new RomZomSkip(this);
		menu=play;
