...
bake.cmd.lua2js		=	bake.path_clean_exe( bake.cd , '/bin/lua2js' )
...
for i,v in ipairs(bake.files_lua) do

	pp.loadsave( 'src/'..v..'.lua' , bake.cd_out..'/src/'..v..'.lua' )
	bake.execute( bake.cd_base , bake.cmd.lua2js , ' '..bake.cd_out..'/src/'..v..'.lua '..bake.cd_out..'/src/'..v..'.as' )
