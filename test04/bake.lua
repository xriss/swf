...
--xtra.copyfile( '../import/out/WetDike_import.swf' , 'out/WetDike_import.swf' )
...
for i,v in ipairs( bake.files_swf ) do
	...
	bake.execute( bake.cd_base , bake.cmd.mtasc , '-main -version 9 -v -cp '..bake.cd_out..'/src -cp '..bake.cd..'/class -swf '..bake.cd_out..'/'..v..'.swf '..bake.cd_out..'/src/'..v..'.as' )
