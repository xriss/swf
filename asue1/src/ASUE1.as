...
//		_root.gofaster=1; // default anim speed multiplier
		...
		_root.asue1=new ASUE1();
		_root.signals=new BetaSignals(_root.asue1);
		_root.comms=new BetaComms(_root.asue1);
